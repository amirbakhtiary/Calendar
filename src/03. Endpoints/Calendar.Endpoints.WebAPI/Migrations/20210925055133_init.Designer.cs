...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Calendar.Core.Domain.EventItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Calendar.Core.Domain.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Calendar.Core.Domain.Member", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Calendar.Core.Domain.EventItem", b =>
                {
                    b.HasOne("Calendar.Core.Domain.Member", "EventOrganizer")
                        .WithMany("EventOrganizers")
                        .HasForeignKey("EventOrganizerId");

                    b.HasOne("Calendar.Core.Domain.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("EventItemMember", b =>
                {
                    b.HasOne("Calendar.Core.Domain.EventItem", null)
                        .WithMany()
                        .HasForeignKey("EventItemsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Calendar.Core.Domain.Member", null)
                        .WithMany()
